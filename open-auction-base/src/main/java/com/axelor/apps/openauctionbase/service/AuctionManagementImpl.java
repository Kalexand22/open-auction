...
public class AuctionManagementImpl implements AuctionManagement{
    ...
    @Override
    public void changeActivity(String pActivityCode, String pMissionNo, String pAuctionNo, String pLotNo,
            String pLotTemplate, Boolean Add, Integer pAuctionLineNo) {
        // TODO Auto-generated method stub
    ...
    @Override
    public void createAuctionLine(String pAuctionNo, String pLotNo, Integer pPassingOrderNo, String pPassingIndexNo) {
        // TODO Auto-generated method stub
        
    }

    @Override
    public void retrieveLotCurrentAuction(AuctionLine pLot, AuctionLine pAuctionLine, Boolean pExcludeLine) {
        // TODO Auto-generated method stub
