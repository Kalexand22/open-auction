...
public class LotTemplateManagementImpl implements LotTemplateManagement {
    ...
    @Override
    public void CreateLot(LotQuickInputJournal pLotQuickInputJournal, Lot pNewLot, Partner pContactNo) {
        ...
        //   lLot."Date To Auction From" := pLotQuickInputJournal."Date To Auction From";   //AP15 isat.zw
        ...
        //       lLotUnitofMeasure2."Qty. per Unit of Measure" := lLotUnitofMeasure."Qty. per Unit of Measure";
    ...
    @Override
    public Lot CreateLotFromMission(LotQuickInputJournal pLotQuickInputJournal, MissionHeader pMissionHeader) {
        // TODO Auto-generated method stub
        return null;
    }

    @Override
    public void PostLotQuickInputFromMission(LotQuickInputJournal pLotQuickInputJournal, MissionHeader pMissionHeader) {
        // TODO Auto-generated method stub
    ...
    @Override
    public void CreateLotValueEntry(LotQuickInputJournal pLotQuickInputJournal, Lot pLot, MissionHeader pMissionHeader,
    ...
    @Override
    public void CreateLotValueEntryReserve(LotQuickInputJournal pLotQuickInputJournal, Lot pLot,
            MissionHeader pMissionHeader, MissionLine pMissionLine) {
        // TODO Auto-generated method stub
        
    }

    @Override
    public void CreateLotValueEntryEstimate(LotQuickInputJournal pLotQuickInputJournal, Lot pLot,
            MissionHeader pMissionHeader, MissionLine pMissionLine) {
        // TODO Auto-generated method stub
    ...
    @Override
    public void CreateLotValueEntryAuctEstim(LotQuickInputJournal pLotQuickInputJournal, Lot pLot,
            MissionHeader pMissionHeader, MissionLine pMissionLine) {
        // TODO Auto-generated method stub
    ...
    @Override
    public void CreateLotValueEntryAppraisal(LotQuickInputJournal pLotQuickInputJournal, Lot pLot,
            MissionHeader pMissionHeader, MissionLine pMissionLine) {
        // TODO Auto-generated method stub
    ...
    @Override
    public void CreateLotValueEntryQuotation(LotQuickInputJournal pLotQuickInputJournal, Lot pLot,
            MissionHeader pMissionHeader, MissionLine pMissionLine) {
        // TODO Auto-generated method stub
    ...
    @Override
    public BigDecimal CalcCommissionWithBaseAmount(LotInputJournal pLotInputJournal, BigDecimal pBaseAmount) {
        // TODO Auto-generated method stub
        return null;
    }

    @Override
    public String CreateLotFromJudicialMission(MissionLine pOriginMissionLine,
    ...
    @Override
    public void PostLotQuickInputFromJuMission(LotQuickInputJournal pLotQuickInputJournal,
            MissionLine pOriginMissionLine) {
        // TODO Auto-generated method stub
    ...
    @Override
    public void CreateLotValueEntryFromLot(String pLotNo, Date pPostingDate, String pEntryType, BigDecimal pAmount,
            BigDecimal pMinAmount, BigDecimal pMaxAmount, Partner pContactNo) {
        // TODO Auto-generated method stub
        
    }

    @Override
    public void SetToRegistIntegrationLot(Boolean pToRegistIntegrationLot, Integer pRegistIntegrationEntryNo) {
        // TODO Auto-generated method stub
