...
public interface MissionStatusManagement {
    ...
    //PROCEDURE ActivityStatusFromActivity@1000000000(VAR pMissionActivityLine@1000000000 : Record 8011457);
    public void activityStatusFromActivity(
        MissionActivityLine pMissionActivityLine);    
    //PROCEDURE DemandActivityLineStatus@1000000006(VAR pMissionActivityLine@1000000002 : Record 8011457);
    public void demandActivityLineStatus(
        MissionActivityLine pMissionActivityLine);        
    ...
    //PROCEDURE ChangeToSpecificStatusMission@1000000008(VAR pMissionHeader@1000000000 : Record 8011402;pStatus@1000000002 : 'Initial,Current,Done,Waiting,Canceled,Finished');
    public void changeToSpecificStatusMission(
        MissionHeader pMissionHeader, String pStatus);
